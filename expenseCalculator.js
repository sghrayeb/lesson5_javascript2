        ...
        ***********************************************************************************************/
        ...
        if (status == 0) { 
          ...
          *******************************************************************************/
                ...
                // Compute tax for married file jointly filers
               if (income <= 18550){
                 tax = income * 0.10;
                 taxRate = 10;
               }//end of nested if
          ...
          *******************************************************************************/
               ...
               // Compute tax for married file separately filers
               if (income <= 9275){
                 tax = income * 0.10;
                 taxRate = 10;
               }//end of nested if
          ...
          *******************************************************************************/
               ...
               if (income <= 13250){
                 ...
                 taxRate = 33;
                  ...
                  tax = 13250 * 0.10 + (50400 - 13250) * 0.15 +
                       (130150 - 50400) * 0.25 + (210800 - 130150) * 0.28 +
                       (income - 210800) * 0.33 + (income - 413350) * 0.35;
                  taxRate = 35;
               }//end of else if
               else {
                  tax = 13250 * 0.10 + (50400 - 13250) * 0.15 +
                       (130150 - 50400) * 0.25 + (210800 - 130150) * 0.28 +
                       (income - 210800) * 0.33 + (income - 413350) * 0.35 + (income - 441000) * .396;
                  taxRate = 39.6;
               }//end of nested if   
